...
// Re-export FFI functions at module level so existing `crate::alloc::miri_alloc`
// call sites in string submodules continue to work.
pub use ffi::*;

/// Stable FFI interface for memory allocation.
pub mod ffi {
