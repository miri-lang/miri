...
mod tests {
    ...
    use crate::mir::{ExecutionModel, LocalDecl};

    fn new_local_with_mir_ty(body: &mut Body, mir_ty: MirType) -> crate::mir::Local {
    ...
    fn test_ty_projected_constant() {
        ...
        let c = Constant {
            ...
            literal: Literal::Integer(crate::ast::literal::IntegerLiteral::I32(42)),
        };
    ...
    #[test]
    fn test_resolve_place_mir_type_custom_field() {
        let span = Span::default();
        let mut body = Body::new(0, span, ExecutionModel::Cpu);
        ...
        assert_eq!(resolve_place_mir_type(&place, &body), Some(MirType::I32));
    }
}
