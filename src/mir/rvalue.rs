...
/// Re-export MathIntrinsic from the AST layer (it has no MIR dependencies
/// and is properly scoped there to avoid layer-crossing imports).
pub use crate::ast::math_intrinsic::MathIntrinsic;
