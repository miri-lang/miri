...
fn test_list_literal_int() {
    check_expr_type("[1, 2, 3]", Type::List(Box::new(miri::ast::IdNode::new(0, miri::ast::ExpressionKind::Type(Box::new(Type::Int), false), 0..0))));
}

#[test]
fn test_list_literal_string() {
    check_expr_type("[\"a\", \"b\"]", Type::List(Box::new(miri::ast::IdNode::new(0, miri::ast::ExpressionKind::Type(Box::new(Type::String), false), 0..0))));
}
