...
const CONFORMANCE_EXCLUSIONS: &[(&str, &str)] = &[
    ...
    ("MER_BLD_006", "Command-invocation diagnostic (miri view); not reachable from .mi source"),
    ("MER_BLD_007", "Command-invocation diagnostic (miri view); not reachable from .mi source"),
    ("MER_BLD_008", "Command-invocation diagnostic (miri view); not reachable from .mi source"),
