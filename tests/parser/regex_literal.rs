...
fn test_regex_literal_assignment() {
    parser_test(r#"let pattern = re"^\d+$"im"#, vec![
...
fn test_regex_in_function_call() {
    parser_test(r#"text.matches(re"[a-z]+")"#, vec![
...
fn test_regex_with_escaped_quotes() {
    parser_test(r#"let p = re"\"quoted\"""#, vec![
        variable_statement(vec![
            let_variable(
                "p",
                None,
...
fn test_method_call_on_regex_literal() {
    parser_test(r#"re"abc"g.test("abc")"#, vec![
        expression_statement(
            call(
                member(
                    regex_literal("abc", "g"),
...
fn test_empty_regex_literal() {
    parser_test(r#"let empty = re""u"#, vec![
        variable_statement(vec![
            let_variable(
                "empty",
                None,
