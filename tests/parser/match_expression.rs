...
use miri::ast::factory::{
    ...
    type_expr_non_null, type_string, variable_statement,
};
use miri::ast::{opt_expr, BinaryOp, MatchBranch, MemberVisibility, Pattern};
...
match x
    ...
    default: print('other')
",
        vec![expression_statement(match_expression(
            identifier("x"),
            vec![
                MatchBranch {
                    patterns: vec![Pattern::Literal(int_literal(1))],
                    guard: None,
                    body: Box::new(expression_statement(call(
                        identifier("print"),
                ...
                MatchBranch {
                    ...
                    guard: None,
                    body: Box::new(block(vec![expression_statement(call(
                        identifier("print"),
