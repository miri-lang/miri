...
fn test_precedence_of_logical_and_or() {
    ...
    parser_test(
        ...
        vec![expression_statement(logical(
            logical(boolean_literal(true), BinaryOp::And, boolean_literal(false)),
            BinaryOp::Or,
...
fn test_chained_logical_or_expression() {
    ...
    parser_test(
        "a or b or c",
        vec![expression_statement(logical(
            logical(identifier("a"), BinaryOp::Or, identifier("b")),
            BinaryOp::Or,
            identifier("c"),
        ))],
    );
...
fn test_logical_expression_with_parentheses() {
    ...
    parser_test(
        ...
        vec![expression_statement(logical(
            identifier("a"),
            BinaryOp::And,
            logical(identifier("b"), BinaryOp::Or, identifier("c")),
        ))],
    );
}
