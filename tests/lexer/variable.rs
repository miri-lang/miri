...
let b = 2
", vec![
        Token::Let, Token::Identifier, Token::Assign, Token::LBracket, Token::Int, Token::RBracket, Token::ExpressionStatementEnd,
        Token::Let, Token::Identifier, Token::Assign, Token::Int, Token::ExpressionStatementEnd,
    ]);
...
let d = 2
", vec![
        Token::Let, Token::Identifier, Token::Assign, Token::LBrace, Token::Identifier, Token::Colon, Token::Int, Token::RBrace, Token::ExpressionStatementEnd,
        Token::Let, Token::Identifier, Token::Assign, Token::Int, Token::ExpressionStatementEnd,
    ]);
}
