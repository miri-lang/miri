...
", vec![
        ...
        Token::If, Token::Identifier, Token::GreaterThan, Token::Int,
...
fn test_ternary_as_return_value() {
    lexer_test("return 1 if x else 0", vec![
        Token::Return, Token::Int, Token::If, Token::Identifier, Token::Else, Token::Int,
    ]);
}
...
fn test_ternary_in_array_literal() {
    lexer_test("let a = [1, 2, 10 if x else 20]", vec![
        ...
        Token::Int, Token::If, Token::Identifier, Token::Else, Token::Int,
        Token::RBracket,
    ]);
}
