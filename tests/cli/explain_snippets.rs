...
const NOT_VERIFIABLE: &[(&str, &str)] = &[
    ...
    ("MER_BLD_006", "emitted by the view command's anchor matching, not by compiling a source file"),
    ("MER_BLD_007", "emitted by the view command's anchor matching, not by compiling a source file"),
