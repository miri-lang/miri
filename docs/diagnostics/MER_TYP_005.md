...
No check emits this code. It was assigned when the type checker reported a variant that does not exist on the enum
...
`MER_TYP_038` (Invalid Enum Variant), which carries the specific case in its message.
