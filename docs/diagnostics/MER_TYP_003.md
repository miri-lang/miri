...
No check emits this code. It was assigned when the type checker reported a type reference that does not resolve
...
`MER_TYP_043` (Type Not Found), which carries the specific case in its message.
