...
No check emits this code. It was assigned when the type checker reported a function whose body does not satisfy its declared return type
...
`MER_TYP_054` (Invalid Function Signature), which carries the specific case in its message.
