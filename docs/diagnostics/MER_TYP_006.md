...
No check emits this code. It was assigned when the type checker reported operands whose types do not agree
...
`MER_TYP_002` (Type Mismatch), which carries the specific case in its message.
