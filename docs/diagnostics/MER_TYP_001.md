...
No check emits this code. It was assigned when the type checker reported a name that does not resolve in any accessible scope
...
`MER_TYP_034` (Undefined Name), which carries the specific case in its message.
