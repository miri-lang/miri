...
No check emits this code. It was assigned when the type checker reported a call applied to something that is not a function
...
`MER_TYP_032` (Not Callable), which carries the specific case in its message.
